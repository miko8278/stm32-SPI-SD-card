...
f"ur den ansoluten Gr"o"steil aller heutigen SD-Karten. 
...
werden muss zuz"uglich aller potentiellen Wartezeiten im SD-Controller, so reicht
...
\begin{listing}[H]
    ...
    \end{minted}
\caption{Auszug aus der Funktion \cpp{SD_SendCmd()}}
\label{listing:schreibfunktionen}
\end{listing}
...
Das endg"ultige Fazit ist hier, dass der zus"atzliche Datenschutz durch das littlefs-Dateisystem die h"ohere Komplexit"at
