...
Weiterhin kann bei batteriebetriebenen Anwendungen der geringere Energiebedarf 
eines Mikrocontrollers von Bedeutung sein.
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\linewidth]{Hard_Bilder/Schaltplan_main_highres.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\linewidth]{Hard_Bilder/Schaltplan_spi_highres.png}}
...
\MP{b}{0.5}{
    \begin{figure}[H]
        \centering
        \includegraphics[height=7cm]{Hard_Bilder/sdadapter_sold.jpg}
...
\MP{b}{0.5}{
    \begin{figure}[H]
        \centering
        \includegraphics[height=7cm]{Hard_Bilder/sdadapter_broken.jpg}
...
einem \text{0x00} signalisiert, dass alle Daten erfolgreich im Flash abgelegt werden konnten.\\
...
Dieser Ablauf erfolgt f"ur alle zu schreibenen Bl"ocke in einer Schleife. 
...
abrufen. Diese Funktion nutzt den SD-Befehl CMD9 \enquote{Send CSD (Card Specific Data)}.
...
dass sie eine von der SD-Karte fixe 16 Byte Sequenz erh"alt, die sogenannte CSD.
...
eine moderne SDHC/SDXC-Karten (CSD V2.0) vorliegt. Alle Details befinden sich in der SD-Spezifikation.
