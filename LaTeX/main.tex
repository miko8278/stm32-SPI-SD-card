...
unterschiedlichen Optimierungsstufen. F"ur FatFs wurde eine minimale Konfiguration verwendet.
...
in einer h"oheren Programmgr"o"se widerspiegelt.
            ...
            \begin{table}[H]
                ...
                \hline
                \textbf{Optimierungsstufe} & \textbf{Dateisystem} & \textbf{Flash (kB)} & \textbf{Statischer RAM (kB)} \\
                \hline
                \multirow{3}{*}{-O0} & littlefs & 57,504 & 2,184 \\
                                      & NoFs     & 13,424 & 2,512 \\
                                      & FatFs    & 28,304 & 2,008 \\
                \hline
                \multirow{3}{*}{-O1} & littlefs & 39,716 & 2,168 \\
                                      & NoFs     &  3,120 & 2,080 \\
                                      & FatFs    & 19,316 & 1,576 \\
                \hline
                \multirow{3}{*}{-O2} & littlefs & 39,308 & 2,168 \\
                                      & NoFs     &  2,404 & 2,080 \\
                                      & FatFs    & 17,536 & 1,576 \\
                \hline
                \multirow{3}{*}{-O3} & littlefs & 47,596 & 2,168 \\
                                      & NoFs     &  2,720 & 2,080 \\
                                      & FatFs    & 18,612 & 1,576 \\
                \hline
                \multirow{3}{*}{-Os} & littlefs & 35,148 & 2,168 \\
                                      & NoFs     &  2,124 & 2,080 \\
                                      & FatFs    & 15,044 & 1,576 \\
                \hline
                \end{tabular}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=8cm]{Bilder_Plot/1_fatfs_dateierstellzeit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=8cm]{Bilder_Plot/2_littlefs_dateierstellzeit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=8cm]{Bilder_Plot/3_WT2_littlefs_dateierstellzeit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=8cm]{Bilder_Plot/4_dateierstellzeit_all.png}
...
\subsection{Versuch 3: Analyse der Schreibfehlerraten mittels pseudorandomisierter Zeichenfolge}\label{sec:v3}
Die Idee dieses Versuches ist einerseits die Konsistenz der Schreiboperationen
bei zuf"alligen oder pseudo-zuf"alligen Daten festzustellen, andererseits die Schreibperformance
bei dem Anh"angen von Daten an eine bereits existierende Datei im Gegensatz zur Neuerstellung zu untersuchen.
...
\begin{figure}[H]
    \centering
    \includegraphics[height=8cm]{Bilder/stm-killswitch.png}
...
littlefs problemlos auf moderne Mikrocontroller, 
so hat FatFs schon in einer kleinen Standardkonfiguration bereits die halbe Gr"o"se und l"asst
sich durch die Einschr"ankung von Optionen sogar noch weiter verkleinern.
