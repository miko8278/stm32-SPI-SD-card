...
\subsection{littlefs FUSE wrapper}
...
einem frisch formatierten FAT32 erhebliche Performanceprobleme. Diese k"onnen nur durch Neuformatierung oder
durch spezialisierte Software wie \enquote{fsck (file system check)}, beseitigt werden.  
