...
Nachteile sind die verh"altnism"asig hohen Laufzeitkosten (h"aufig O($n^2$)) und der hohe RAM-Verbrauch,
...
\begin{figure}[H]
    ...
    \label{fig:cowdesign}
\end{figure}
COW-Dateisysteme bieten eine langsamere, aber zumindest vergleichbare Performance zu blockbasierten Dateisystemen, 
...
um den Faktor N. CObW wird bei littlefs also f"ur die gr"o"sen Datenstrukturen verwendet und bringt 
den Vorteil des Wear-Leveling mit sich, sowie eine Dateikonsistenzgarantie bei unerwartetem Stromausfall. \\
...
die Anzahl der Nullen einer Zahl in Bin"ardarstellung.
...
\begin{figure}[H]
    \centering
    \includegraphics[height=4cm]{Bilder_Diagramme/littlefsmetadata.png}
...
Die Vorteile, die das System mit sich bringt ist die dauerhafte Konsistenz der Metadaten, da nichts
...
f"ur technisch versierte und mit GitHub vertraute Personen problemlos in unter einer Stunde 
...
\texttt{test/nofs\_append\_write\_test\_1024.cpp}. Die aufgenommenen Testdaten sind unter
\href{}{github:/test\data/Writetest5} erreichbar. 
